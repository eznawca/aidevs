...
class Index
{
	const MENU_INDEX = [
		// 1. Tydzień
		'C01L01' => ['desc' => 'Wprowadzenie do Generative AI', 'scripts' => ['helloapi'], 'quiz' => 'https://zadania.aidevs.pl/quiz/c01l01_start', 'chat' => [
		...
		'C01L04' => ['desc' => 'OpenAI API i LangChain', 'scripts' => ['moderation','blogger'], 'quiz' => 'https://zadania.aidevs.pl/quiz/c01l04_nmdt', 'chat' => [], 'circle' => 'https://bravecourses.circle.so/c/lekcje-programu/c01l04-openai-api-i-langchain'],
		'C01L05' => ['desc' => 'Prompt Engineering', 'scripts' => ['liar'], 'quiz' => 'https://zadania.aidevs.pl/quiz/c01l05_tger', 'chat' => [], 'circle' => 'https://bravecourses.circle.so/c/lekcje-programu/c01l05-prompt-engineering'],
		// 2. Tydzień
